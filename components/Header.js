...
function Header() {
    return (
        <div id="headerWrapper" className=" flex items-center justify-around my-8  lg:p-4 lg:mx-4 lg:rounded-t-lg xl:mx-20 z-50">
            <div id="headerImage" className="w-40">
                <Image src={PetCoinWhiteFull} alt="PetCoin corporate logo shown in white" />
            </div>
            <div className="">
                <div id="nav" className="bg-orange-600 rounded-full p-2 fixed bottom-4 right-4 w-[60px] h-[60px] sm:top-8 lg:hidden border mr-3 z-40">
